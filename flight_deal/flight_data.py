...
def find_cheapest_flight(data):
    ...
    nr_stop = len(first_flight["itineraries"][0]["segments"]) - 1
    ...
    cheap_flight = FlightData(lowest_price,departure_airport,arrival_airport,departure_date,arrival_date,nr_stop)
    ...
    for flight in data["data"]:
        ...
        if lowest_price > price_of_flight :
            ...
            arrival_airport =flight["itineraries"][0]["segments"][nr_stop]["arrival"]["iataCode"]
